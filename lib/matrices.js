                ...
                for (var m=0; m<vElements.length; m++) {
                    ...
                    if (RelatesElement =='') {
                        ...
                        for (var x=0; x<vPlugins.length; x++) {
                            ...
                            for (var y=0; y<vAreas.length; y++) {
                                //check if exists already an instance with value and get value to "elementValue"
                                var TestElementValue = xpath.select("/Audit/Preassessment/paArea[@nr='" + AreaId + "']/paIssue[@nr='" + IssueId + "']/paMatrix[@nr='01']/paSection[@nr='" + vSections[k].nodeValue + "']/Instances/IElement[@nr='" + Sections[k].nodeValue + '|' + vDomains[n].nodeValue + '_' + vElements[m].nodeValue + '|' + vAreas[y].nodeValue + '#' + vPlugins[x].nodeValue + "']/@name",doc);
                                if (TestElementValue.length > 0){ 
                                    elementValue = TestElementValue[0].nodeValue;
                                }    
...
function SaveFindingMatrix(fileid, Catalog) {
    ...
    if (Catalog.FindingId == '(New)'){
        ...
        res[0].setAttribute('nr', 'F' + year.toString() + ('0' + month.toString).substring(0, 2)  + ('0' + day.toString).substring(0, 2) + '-' + ('0' + hour.toString).substring(0, 2) + ('0' + minutes.toString).substring(0, 2) + ('0' + seconds.toString).substring(0, 2));
        ...
        res[0].setAttribute('include','Yes');
        ...
        if (Catalog.Source == 'AITAM'){
            ...
            res[0].setAttribute('domain',vItems[1] + ' ' + xpath.select("/Audit/ActiveITAuditDomains/Domain[@nr='" + vItems[1] + "']/title/tx[@l='" + credentials.WorkLang + "']/@name",doc)[0].nodeValue);
            res[0].setAttribute('area',vItems[2] + ' ' + xpath.select("/Audit/ActiveITAuditDomains/Domain[@nr='" + vItems[1] + "']/Area[@nr='" + vItems[2] + "']/title/tx[@l='" + credentials.WorkLang + "']/@name",doc)[0].nodeValue);
            res[0].setAttribute('issue',vItems[3] + ' ' + xpath.select("/Audit/ActiveITAuditDomains/Domain[@nr='" + vItems[1] + "']/Area[@nr='" + vItems[2] + "']/Issue[@nr='" + vItems[3] + "']/title/tx[@l='" + credentials.WorkLang + "']/@name",doc)[0].nodeValue);
        } else {
            var res = xpath.select("/Audit/Cases/Case[@nr='" + Catalog.FindingId + "']/cts/.",doc);
            res[0].setAttribute('source', Catalog.Source);
            res[0].setAttribute('domain',vItems[1] + ' ' + xpath.select("/Audit/PlugIns/PlugIn[@id='" + Catalog.Source + "']/Domain[@nr='" + vItems[1] + "']/title/tx[@l='" + credentials.WorkLang + "']/@name",doc)[0].nodeValue);
            res[0].setAttribute('area',vItems[2] + ' ' + xpath.select("/Audit/PlugIns/PlugIn[@id='" + Catalog.Source + "']/Domain[@nr='" + vItems[1] + "']/Area[@nr='" + vItems[2] + "']/title/tx[@l='" + credentials.WorkLang + "']/@name",doc)[0].nodeValue);
            res[0].setAttribute('issue',vItems[3] + ' ' + xpath.select("/Audit/PlugIns/PlugIn[@id='" + Catalog.Source + "']/Domain[@nr='" + vItems[1] + "']/Area[@nr='" + vItems[2] + "']/Issue[@nr='" + vItems[3] + "']/title/tx[@l='" + credentials.WorkLang + "']/@name",doc)[0].nodeValue);
        }
