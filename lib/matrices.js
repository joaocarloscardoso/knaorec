...
function LoadRecommendationMatrix(fileid, RecommendationId) {
    ...
    if (RecommendationId != 'New') {
        var vSource = xpath.select("/Audit/Cases/Case[@nr='" + RecommendationId + "']/cts/@source",doc)[0].nodeValue;
        var vDomain = xpath.select("/Audit/Cases/Case[@nr='" + RecommendationId + "']/cts/@domain",doc)[0].nodeValue;
        var vArea =xpath.select("/Audit/Cases/Case[@nr='" + RecommendationId + "']/cts/@area",doc)[0].nodeValue;
        var vIssue = xpath.select("/Audit/Cases/Case[@nr='" + RecommendationId + "']/cts/@issue",doc)[0].nodeValue;

        if (xpath.select("/Audit/Cases/Case[@nr='" + RecommendationId + "']/quote[@type='description']/.",doc)[0].firstChild === null)
        {
            tempDescription= '';
        }else{
            tempDescription= xpath.select("/Audit/Cases/Case[@nr='" + RecommendationId + "']/quote[@type='description']/.",doc)[0].firstChild.nodeValue;
        };
        if (xpath.select("/Audit/Cases/Case[@nr='" + RecommendationId + "']/quote[@type='recommendation']/.",doc)[0].firstChild === null)
        {
            tempRecommendation= '';
        }else{
            tempRecommendation= xpath.select("/Audit/Cases/Case[@nr='" + RecommendationId + "']/quote[@type='recommendation']/.",doc)[0].firstChild.nodeValue;
        };
        ...
        var NewEntry = {
            ...
            Actionplan: '',
            Timeline: '',
            Status: '', //xpath.select("/Audit/Cases/Case[@nr='" + RecommendationId + "']/@nm",doc)[0].nodeValue,
            Outcome: '',
            Responsible: ''
        };
    } else {
