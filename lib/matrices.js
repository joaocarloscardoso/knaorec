...
function LoadPreAssessMatrix(fileid, AreaId, IssueId) {
    ...
    var NewEntry = {
        ...
        Sections: [
            {
                SectionId: '01',
                SectionName: 'Do the staff assigned to this IT-audit have sufficient competence and required capabilities?',
                Elements: [
                    {
                        ElementId:'01',
                        ElementName:'Criteria: ISSAI 5300.8 and 16. -  The IT audit team is composed of members that collectively have the competence to perform the IT Audit.',
                        Type:'text', 
                        Values:'',
                        Value:'Yes'
                    },
                    {
                        ElementId:'02',
                        ElementName:'Criteria: ISSAI 100.36. – Auditors should comply with the relevant ethical requirements and be independent.',
                        Type:'list', 
                        Values:'Yes|No',
                        Value:'Yes'
                    }
            ...
            {
                SectionId: '02',
                SectionName: 'Have all staff members assigned to this IT-audit signed a statement where they accept to comply with all relevant ethical requirement and have assured independence to perform this audit engagement?',
                Elements: [
                    {
                        ElementId:'01',
                        ElementName:'Criteria: ISSAI 5300.8 and 16. -  The IT audit team is composed of members that collectively have the competence to perform the IT Audit.',
