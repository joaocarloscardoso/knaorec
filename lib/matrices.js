            ...
            for (var n=0; n<vDomains.length; n++) {
                ...
                for (var m=0; m<vElements.length; m++) {
                    ...
                    if (RelatesElement =='') {
                        ...
                        // elementValue = "/Audit/Preassessment/paArea[@nr='" & vPointerArea & "']/paIssue[@nr='" + vPointerIssue + "']/paMatrix[@nr='01']/paSection[@nr='" & vSection.GetAttribute("nr") & "']/Instances/IElement[@nr='" & vSection.GetAttribute("nr") & "|" & vDomain.GetAttribute("nr") & "_" & vElement.GetAttribute("nr") & "']"
