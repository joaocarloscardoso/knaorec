...
function CreateDictionary() {
    ...
    session
        ...
        .then(result => {
            fs.writeFileSync(NewDictFile, '');
                ...
                fs.appendFileSync(NewDictFile, record._fields[0].properties.Name +'|Country\n');
    ...
    session
        ...
        .then(result => {
            result.records.forEach(function(record){
                fs.appendFileSync(NewDictFile, record._fields[0].properties.Definition +'|Function\n');
               // console.log(record._fields[0].properties.Name);
            });
        })
        .catch(error => {
    ...
    session
        ...
        .then(result => {
            result.records.forEach(function(record){
                fs.appendFileSync(NewDictFile, record._fields[0].properties.Definition +'|ActivityDomain\n');
               // console.log(record._fields[0].properties.Name);
            });
        })
        .catch(error => {
    ...
    session
        ...
        .then(result => {
            result.records.forEach(function(record){
                fs.appendFileSync(NewDictFile, record._fields[0].properties.Definition +'|Process\n');
            // console.log(record._fields[0].properties.Name);
            });
        })
        .catch(error => {
    ...
    session
        ...
        .then(result => {
            result.records.forEach(function(record){
                fs.appendFileSync(NewDictFile, record._fields[0].properties.Definition +'|Goal\n');
            // console.log(record._fields[0].properties.Name);
            });
        })
        .catch(error => {
    ...
    session
        ...
        .then(result => {
            result.records.forEach(function(record){
                fs.appendFileSync(NewDictFile, record._fields[0].properties.Definition +'|Topics\n');
            // console.log(record._fields[0].properties.Name);
            });
        })
        .catch(error => {
