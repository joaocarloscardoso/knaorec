...
function LoadAuditRecommendations(doc, auditid, sellang) {
    Catalog = [];
    tempDescription = '';
    tempTimeline ='';
    tempStatus='';
    ...
    for (var i=0; i<vRecommendations.length; i++) {
        if (xpath.select("/portfolio/audits/Audit/About[@id='" + auditid + "']/../Recommendations/Recommendation[@nr='" + vRecommendations[i].nodeValue + "']/quote[@type='description' and @l='" + sellang +"']/.",doc)[0].firstChild === null)
        {
            tempDescription= '';
        }else{
            tempDescription= xpath.select("/portfolio/audits/Audit/About[@id='" + auditid + "']/../Recommendations/Recommendation[@nr='" + vRecommendations[i].nodeValue + "']/quote[@type='description' and @l='" + sellang +"']/.",doc)[0].firstChild.nodeValue;
        };
        if (xpath.select("/portfolio/audits/Audit/About[@id='" + auditid + "']/../Recommendations/Recommendation[@nr='" + vRecommendations[i].nodeValue + "']/quote[@type='timeline' and @l='" + sellang +"']/.",doc)[0].firstChild === null)
        {
            tempTimeline= '';
        }else{
            tempTimeline= xpath.select("/portfolio/audits/Audit/About[@id='" + auditid + "']/../Recommendations/Recommendation[@nr='" + vRecommendations[i].nodeValue + "']/quote[@type='timeline' and @l='" + sellang +"']/.",doc)[0].firstChild.nodeValue;
        };
...
function LoadAuditRecommendationsForAnalysis(doc, auditid, sellang) {
    ...
    res = xpath.select("/portfolio/audits/Audit/About[@id='" + auditid + "']/title/tx[@l='" + credentials.WorkLang + "']/@descriptionfile",doc);
    if (res.length==1 && res[0] != null){
        tempURL = res[0].nodeValue;
    } else {
        tempURL = '';
    };
    ...
    var List  = {
        ...
        Recommendations: LoadAuditRecommendations(doc, auditid, sellang.toLowerCase()),
    ...
    return new Promise(function(resolve, reject){
        database.QueryDataAudits(dbQuery, dbfields, sortfields).then(function(Result){
            ...
            for (var i=0; i<Result.length; i++) {
                ...
                if (typeof xpath.select("/About/title/tx[@l='" + credentials.WorkLang + "']/@nm",doc)[0] !== 'undefined'){
                //if (res.length==1 && res[0] != null){
                    //NewEntry.AuditTitle = res[0].nodeValue;
                    NewEntry.AuditTitle = xpath.select("/About/title/tx[@l='" + credentials.WorkLang + "']/@nm",doc)[0].nodeValue;
                } else {
                    //res = xpath.select("/About/title/tx[@l='" + credentials.WorkLang + "']/@name",doc);
                    //if (res.length==1 && res[0] != null){
                    if (typeof xpath.select("/About/title/tx[@l='" + credentials.WorkLang + "']/@name",doc)[0] !== 'undefined'){
                        NewEntry.AuditTitle =xpath.select("/About/title/tx[@l='" + credentials.WorkLang + "']/@nm",doc)[0].nodeValue;
                        //NewEntry.AuditTitle = res[0].nodeValue;
                    } else {
                        NewEntry.AuditTitle = '';
                ...
                if (typeof xpath.select("/About/@yearCovered",doc)[0] !== 'undefined'){
                    NewEntry.AuditYear = xpath.select("/About/@yearCovered",doc)[0].nodeValue;
                } else {
                    NewEntry.AuditYear ='';
                };

                console.log("a: " + NewEntry.AuditYear);
