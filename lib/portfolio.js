...
function ListPortfolios(userid, published) {
    ...
    var dbfields = { _id: 1, userid: 1, datepub: 1, portfolioid: 1, data: 1, coverage: 1, org: 1, publish: 1 };
    var sortfields = {"datepub": -1};
        ...
        database.QueryData(dbparams, dbfields, sortfields).then(function(Result){
            ...
            for (var i=0; i<Result.length; i++) {
                ...
                var NewEntry = {
                    ...
                    name: xpath.select("/portfolio/name/tx[@l='" + credentials.WorkLang + "']/@nm",doc)[0].nodeValue,
                    description: xpath.select("/portfolio/name/tx[@l='" + credentials.WorkLang + "']/@description",doc)[0].nodeValue,
