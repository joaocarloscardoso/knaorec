...
function LoadRecPriorities(fileid) {
    ...
    var CatPriorities = [];
    for (index = 0, SelPrioritiesLen = (ColPriorities.length-1); index < SelPrioritiesLen; ++index) {
        var NewEntry = {
...
function LoadRecCharacterization(fileid) {
    ...
    for (index = 0, SelCharacterizationLen = (ColCharacterization.length-1); index < SelCharacterizationLen; ++index) {
        var NewEntry = {
...
function LoadRecImportance(fileid) {
    ...
    var CatImportance = [];
    for (index = 0, SelImportanceLen = (ColImportance.length-1); index < SelImportanceLen; ++index) {
        var NewEntry = {
...
function LoadRecLevel(fileid) {
    ...
    var CatLevel = [];
    for (index = 0, SelLevelLen = (ColLevel.length-1); index < SelLevelLen; ++index) {
        var NewEntry = {
